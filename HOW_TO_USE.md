...
If you are evaluating the app and do not want to run the Microsoft assessment yet, you can use the sample CSV/XLSX in:
...
3. Optional quick trial: use the sample files in `report samples/`.
...
You can compare your output against the provided themed examples in `report samples/` (`Sample_*.html` and matching `.jpeg` previews).
